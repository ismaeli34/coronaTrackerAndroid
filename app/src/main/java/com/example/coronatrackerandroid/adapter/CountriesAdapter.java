...
import com.example.coronatrackerandroid.ui.countries.CountriesFragment;
...
public class CountriesAdapter extends ArrayAdapter<CountryModel> {
    ...
    private Context context;
     ...
     List<CountryModel> countryModelListFiltered;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Glide.with(context).load(countryModelListFiltered.get(position).getCountryInfo().getFlag()).into(imageView);
